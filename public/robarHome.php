      ...
      <div class="modal-content col-xs-12 col-md-8 col-md-offset-2">
        ...
        <div class="modal-body">
          ...
          <div id="form-content2">
               ...
               <input type="text" class="form-control inputSpace" name="first_name" id="lname" placeholder="Name" required />
               </div>
               <br>
               
               <div class="form-group">
               <input type="text" class="form-control inputSpace" name="email" id="lname" placeholder="Your Email" required />
               </div>
                   
               <div class="form-group">
               <input type="text" class="form-control inputSpace" name="telephone" id="lname" placeholder="Phone Number" required />
               </div>
                 
               <div class="form-group">
               <textarea type="textarea" class="form-control" name="comments" id="lname" placeholder="Comments"></textarea>
               </div>
